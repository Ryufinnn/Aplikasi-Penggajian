...
<table width="492" border="1" class="table table-striped">
    <tr>
      ...
      <td width="107"><div align="center"><strong>Aksi</strong></div></td>
    </tr>
	<?php
    ...
    <tr>
      ...
      <td><div align="left"><a href="gaji/aksi_gaji.php?proses=hapus&id_gaji=<?php echo $data['id_gaji']?>"><span class="glyphicon glyphicon-floppy-remove"> Hapus</span></a><br />
	        <a href="index.php?p=gaji&page=edit&id_gaji=<?php echo $data['id_gaji']?>"><span class="glyphicon glyphicon-edit"> Edit</span></a></div></td>
    </tr>
	<?php
		$no++;
		}
...
<form id="form1" name="form1" method="post" action="gaji/aksi_gaji.php?proses=edit">
  <table width="311" border="0">
	...
	<tr>
      <td>Tunjangan</td>
      <td><label>
        <input type="text" name="tunjangan" value = "<?php echo $data['tunjangan']?>"/>
      </label></td>
    </tr>
	<tr>
      <td>Potongan</td>
      <td><label>
        <input type="text" name="potongan" value = "<?php echo $data['potongan']?>"/>
      </label></td>
    </tr>
    <tr>
      <td>Total Gaji</td>
...
<tr>
 ...
 <table width="492" border="1" class="table table-striped">
    <tr>
      ...
      <td width="105"><div align="center"><strong>Tgl Gaji  </strong></div></td>
      <td width="120"><div align="center"><strong>Nip </strong></div></td>
      <td width="120"><div align="center"><strong>Nama </strong></div></td>
      <td width="105"><div align="center"><strong>Gaji</strong></div></td>
      <td width="105"><div align="center"><strong>Tunjangan</strong></div></td>
      <td width="105"><div align="center"><strong>Potongan</strong></div></td>
      <td width="105"><div align="center"><strong>Total Gaji</strong></div></td>
  ...
  ?>
    <tr>
      ...
      <td><div align="center"><?php echo $data['potongan'];?></div></td>
      <td><div align="center"><?php echo $data['total_gaji'];?></div></td>
      <td><div align="left"><a href="index.php?p=gaji&page=cetak&id_gaji=<?php echo $data['id_gaji']?>"><span class="glyphicon glyphicon-print"> Cetak</span></a><br />        
    </tr>
    </tr>
  <?php
    $no++;
...
<h4> <B>SLIP GAJI </B></h4>
  ...
  <tr>
      ...
      <td width="207"><label>
  <tr>
      <td width="150">Gaji </td>
      <td width="150"> : </td>
      <td width="150"><?php echo $data['gaji']?> </td>
      <td width="207"><label>
    </tr>
  <tr>
