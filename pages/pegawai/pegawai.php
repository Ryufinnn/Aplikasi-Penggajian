...
<table width="492" border="1" class="table table-striped">
    <tr>
      ...
      <td width="120"><div align="center"><strong>SK </strong></div></td>
      <td width="105"><div align="center"><strong>No Hp</strong></div></td>
      <td width="105"><div align="center"><strong>Alamat</strong></div></td>
      <td width="105"><div align="center"><strong>Jabatan</strong></div></td>
      <td width="105"><div align="center"><strong>Password</strong></div></td>
    ...
    <tr>
      ...
      <td><div align="center"><?php echo $data['sk'];?></div></td>
      ...
      <td><div align="left"><a href="pegawai/aksi_pegawai.php?proses=hapus&nip=<?php echo $data['nip']?>"><span class="glyphicon glyphicon-floppy-remove"> Hapus</span></a><br />
	        <a href="index.php?p=pegawai&page=edit&nip=<?php echo $data['nip']?>"><span class="glyphicon glyphicon-edit"> Edit</span></a></div></td>
    </tr>
	<?php
		$no++;
		}
...
<form id="form1" name="form1" method="post" action="pegawai/aksi_pegawai.php?proses=edit">
  <table width="311" border="0">
    ...
    <tr>
      <td>SK</td>
      <td><label>
        <input type="text" name="sk" value = "<?php echo $data['sk']?>"/>
      </label></td>
    </tr>
	<tr>
      <td>No Hp</td>
